	...
	function stiatExtension(options)
	{
		...
		var stiatObj = 
		{
			...
			category :  
			{
				...
				title : {
					media : {word : 'Jan 6th'}, //Name of the category presented in the task.
					css : {color:'#31b404','font-size':'2em'}, //Style of the category title.
					height : 4 //Used to position the "Or" in the combined block.
				}, 
				media : [ //Stimuli
    		    	{image : 'Capitol Hill_1.png'}, 
    				{image : 'Capitol Hill_2.webp'}, 
    				{image : 'Capitol Hill_3.webp'}, 
    				{image : 'Capitol Hill_4.webp'}
				],
			...
			base_url : {//Where are your images?
				image : 'https://github.com/kaming-chan/iat_base'
			}, 
